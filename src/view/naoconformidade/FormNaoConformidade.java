...
public class FormNaoConformidade extends javax.swing.JDialog {
     ...
     */
    public FormNaoConformidade(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormNaoConformidade.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormNaoConformidade dialog = new FormNaoConformidade(new javax.swing.JFrame(), true);

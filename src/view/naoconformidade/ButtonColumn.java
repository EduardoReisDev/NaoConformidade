...
public class ButtonColumn extends JFrame {
	...
	Object[][] data=
		{
			{"1","Man Utd",new Integer(2013),"21","t"},
			{"2","Man City",new Integer(2014),"3","y"},
			{"3","Chelsea",new Integer(2015),"7","x"},
			{"4","Arsenal",new Integer(1999),"10","w"},
			{"5","Liverpool",new Integer(1990),"19","z"},
			{"6","Everton",new Integer(1974),"1","u"},
		};
	
	
	
	//COLUMN HEADERS
	String columnHeaders[]={"Position","Team","Last Year Won","Trophies","teste"};

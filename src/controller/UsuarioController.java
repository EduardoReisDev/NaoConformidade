...
public class UsuarioController {
    ...
    */
    ...
    public void verificarUsuario(Usuario usuario){
        if(Resources.validarCpf(usuario.getCpf())){
            usuario.setCpf(Resources.removerCaracteresInvalidosCpf(usuario.getCpf()));
            ...
            if(usuario!=null){
                ...
                Mensagens.mensagem(componentePai, "Esse usuário não existe!", "Mensagem", 1);
            }
        }
    }
